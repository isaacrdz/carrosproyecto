    ...
    <div class="portfolio-works wow fadeIn" data-wow-duration="2s">
        ...
        <div class="portfolio-items">
            ...
            <div class="item portfolio-item web seo">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/img-portfolio/portfolio1.jpg" alt="">
            ...
            <div class="item portfolio-item works seo">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/img-portfolio/portfolio2.jpg" alt="">
                <div class="portfolio-details-wrapper">
                    <div class="portfolio-details">
                        <div class="portfolio-meta-btn">
                            <ul class="work-meta">
            ...
            <div class="item portfolio-item web">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/img-portfolio/portfolio3.jpg" alt="">
                <div class="portfolio-details-wrapper">
                    <div class="portfolio-details">
                        <div class="portfolio-meta-btn">
                            <ul class="work-meta">
            ...
            <div class="item portfolio-item web works brands">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/img-portfolio/portfolio4.jpg" alt="">
                <div class="portfolio-details-wrapper">
                    <div class="portfolio-details">
                        <div class="portfolio-meta-btn">
                            <ul class="work-meta">
            ...
            <div class="item portfolio-item web brands">
               ...
               <img src="<?php bloginfo('template_url'); ?>/images/img-portfolio/portfolio5.jpg" alt="">
                <div class="portfolio-details-wrapper">
                    <div class="portfolio-details">
                        <div class="portfolio-meta-btn">
                            <ul class="work-meta">
            ...
            <div class="item portfolio-item works seo">
                ...
                <img src="<?php bloginfo('template_url'); ?>/images/img-portfolio/portfolio6.jpg" alt="">
                <div class="portfolio-details-wrapper">
                    <div class="portfolio-details">
                        <div class="portfolio-meta-btn">
                            <ul class="work-meta">
