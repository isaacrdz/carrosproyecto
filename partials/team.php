                ...
                <div class="row">
                    ...
                    <div id="teams" class="owl-carousel teams">
                        ...
                        <div class="teams-slides col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">
                            <img src="<?php bloginfo('template_url'); ?>/images/img-teams/team1.jpg" alt="">
                        ...
                        <!-- Slides -->
                        <div class="teams-slides col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">
                            <img src="<?php bloginfo('template_url'); ?>/images/img-teams/team2.jpg" alt="">
                        ...
                        <!-- Slides -->
                        <div class="teams-slides col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">
                            <img src="<?php bloginfo('template_url'); ?>/images/img-teams/team3.jpg" alt="">
