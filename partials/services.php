<section id="services" class="section-wrapper">
 ...
 <div class="row">
        ...
        <div class="service-box">
                        <div class="icon"> <h3>Breakfast</h3>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero praesentium quam nulla.</p>
          <img src="<?php bloginfo('template_url'); ?>/images/breakfast.jpg" alt="Custom Image">
          </div>
</div>
                    <div class="col-md-4 col-sm-4 col-xs-12 text-xs-center wow fadeInDown" data-wow-delay=".2s">
        <div class="service-box">
                        <div class="icon"> <h3>Lunch </h3>
                        </div>

                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero praesentium quam nulla.</p>
          <img src="<?php bloginfo('template_url'); ?>/images/lunch.jpg" alt="Custom Image">
                    </div>
</div>
                    <div class="col-md-4 col-sm-4 col-xs-12 text-xs-center wow fadeInDown" data-wow-delay=".2s">
        <div class="service-box">
                        <div class="icon"> <h3>Dinner</h3>
                        </div>

                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero praesentium quam nulla.</p>
          <img src="<?php bloginfo('template_url'); ?>/images/dinner.jpg" alt="Custom Image">
                    </div>
</div>
        ...
        <div class="service-box">
                        <div class="icon">
                            <i class="icon_cog"></i><h3>Rooms</h3>
                        </div>
