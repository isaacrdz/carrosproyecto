<section class="slider-pro slider" id="slider">
    <div class="sp-slides">
        ...
        <div class="sp-slide main-slides">
            ...
            <img class<?php bloginfo('template_url'); ?>/="sp-image" src="images/slider/slider-img-1.jpg" alt="Slider 1"/>
        ...
        <div class="sp-slide main-slides">
        <div class="img-overlay"></div>
            <img class<?php bloginfo('template_url'); ?>/="sp-image" src="images/slider/slider-img-2.jpg" alt="Slider 2"/>

            <h1 class="sp-layer slider-text-big"
            data-position="center" data-show-transition="left" data-hide-transition="right" data-show-delay="1500" data-hide-delay="200">
            <span class="highlight-texts">Mind Blowing Ambiance</span>
            </h1>
        ...
        <div class="sp-slide main-slides">
            ...
            <img class<?php bloginfo('template_url'); ?>/="sp-image" src="images/slider/slider-img-3.jpg" alt="Slider 3"/>

            <h1 class="sp-layer slider-text-big"
            data-position="center" data-show-transition="left" data-hide-transition="right" data-show-delay="1500" data-hide-delay="200">
            <span class="highlight-texts">Best Country Sea Food</span>
            </h1>
